...
import { Menu, X, Sun, Moon, Instagram, Twitter, Youtube, Facebook, MapPin, Mail, Cpu, ExternalLink, LogIn, User, LayoutDashboard, LogOut, ChevronDown } from 'lucide-react';
...
export const Navbar: React.FC = () => {
  ...
  // Keep first 4 visible (Home, About, Leadership, Competitions), rest in dropdown
  ...
  return (
    <nav className="bg-white/90 dark:bg-dark-bg/90 backdrop-blur-md border-b border-gray-200 dark:border-dark-border sticky top-0 z-50 transition-all duration-300">
          ...
          <div className="hidden lg:flex items-center ml-12">
            <div className="flex items-baseline space-x-2">
              ...
              <div className="relative ml-2" ref={dropdownRef}>
                ...
                {isMoreOpen && (
                  <div className="absolute top-full right-0 mt-2 w-56 bg-white dark:bg-dark-surface rounded-xl shadow-xl border border-gray-200 dark:border-dark-border py-2 animate-fade-in overflow-hidden z-50 origin-top-right ring-1 ring-black ring-opacity-5">
                    {moreLinks.map((link) => (
                      <Link
                        key={link.name}
                        to={link.path}
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="lg:hidden bg-white dark:bg-dark-bg border-b border-gray-200 dark:border-dark-border animate-fade-in shadow-lg absolute w-full z-40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-accent-blue dark:hover:text-white transition-all hover:bg-gray-100 dark:hover:bg-white/10 p-2 rounded hover:-translate-y-1"><Instagram size={18} /></a>
              <a href="#" className="text-gray-400 hover:text-accent-blue dark:hover:text-white transition-all hover:bg-gray-100 dark:hover:bg-white/10 p-2 rounded hover:-translate-y-1"><Twitter size={18} /></a>
              <a href="#" className="text-gray-400 hover:text-accent-blue dark:hover:text-white transition-all hover:bg-gray-100 dark:hover:bg-white/10 p-2 rounded hover:-translate-y-1"><Youtube size={18} /></a>
              <a href="#" className="text-gray-400 hover:text-accent-blue dark:hover:text-white transition-all hover:bg-gray-100 dark:hover:bg-white/10 p-2 rounded hover:-translate-y-1"><Facebook size={18} /></a>
            </div>
          </div>
