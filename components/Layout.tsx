        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center gap-3 group shrink-0">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-electric-500 to-violet-600 flex items-center justify-center shadow-glow-blue group-hover:shadow-glow-blue transition-all duration-300 group-hover:scale-105">
                <Cpu size={18} className="text-white" />
              </div>
              <div className="hidden sm:flex flex-col leading-none">
                <span className="font-bold text-sm text-ink tracking-tight">LEHS TSA</span>
                <span className="text-[10px] text-ink-muted font-mono mt-0.5">Little Elm, TX</span>
              </div>
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-2">
              ...
              {siteSettings.instagramLink && (
                <a
                  ...
                  className="p-2 text-ink-muted hover:text-electric-500 transition-colors"
            ...
            >
              ...
              <div className="flex items-center justify-between p-5 border-b border-space-500/50">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-ink">LEHS TSA</span>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-electric-500 to-violet-600 flex items-center justify-center shadow-glow-blue">
                <Cpu size={18} className="text-white" />
              </div>
              <div>
                <div className="font-bold text-ink text-sm">LEHS TSA</div>
                <div className="text-[10px] text-ink-muted font-mono">Little Elm High School</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                >
                  {status === 'done' ? '✓' : status === 'loading' ? '...' : 'Go'}
                </button>
              </div>
              {status === 'done' && (
                <p className="text-xs text-green-400 mt-1.5">You're subscribed!</p>
              )}
              {status === 'error' && (
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="mt-6">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-space-700 border border-space-500/50 text-[10px] text-ink-muted font-mono">
                <span className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" />
                Chapter Active · 2024–2025
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 text-[12px] text-ink-muted">
          ...
          <p className="font-mono">
            Built with <span className="text-red-400">♥</span> by LEHS TSA Webmaster Team
          </p>
        </div>
      </div>
    </footer>
...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="min-h-screen flex flex-col bg-space-900 text-ink font-sans selection:bg-electric-200 selection:text-ink">
      <Navbar />
