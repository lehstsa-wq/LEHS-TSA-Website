...
import { Sparkles, Send, User, Loader2, RefreshCcw } from 'lucide-react';
        ...
        <div className="p-4 border-t border-gray-200 dark:border-dark-border bg-white dark:bg-dark-surface">
          <div className="relative">
            ...
            <button 
              ...
              className="absolute right-2 top-1.5 p-2 bg-accent-blue hover:bg-accent-purple text-white rounded-lg transition-all duration-300 disabled:opacity-50 shadow-md hover:shadow-accent-purple/40 hover:scale-110 active:scale-95 hover:-translate-y-0.5"
            >
              <Send size={18} />
            </button>
          </div>
