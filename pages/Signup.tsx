      ...
      <div className="w-full max-w-md bg-white dark:bg-dark-surface border border-gray-200 dark:border-dark-border rounded-2xl p-8 shadow-2xl animate-fade-in transition-all duration-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            ...
            className="w-full bg-accent-blue hover:bg-accent-purple text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center shadow-lg shadow-accent-blue/25 hover:shadow-accent-purple/40 mt-6 disabled:opacity-50 disabled:cursor-not-allowed group hover:scale-[1.02] hover:-translate-y-1 hover:-rotate-1"
          >
            {isSubmitting ? (
              ...
              <>
                Create Account 
                <ChevronRight size={18} className="ml-2 group-hover:translate-x-2 group-hover:rotate-12 transition-transform duration-300" />
              </>
            )}
          </button>
        </form>
