      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="space-y-6">
            {sortedUpdates.map(update => (
                <div key={update.id} className={`bg-white dark:bg-dark-surface border ${update.isPinned ? 'border-accent-blue/30' : 'border-gray-200 dark:border-dark-border'} rounded-xl p-6 sm:p-8 animate-fade-in shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group`}>
                    <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-accent-blue to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
