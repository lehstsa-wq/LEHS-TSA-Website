...
const roleBadge: Record<string, string> = {
  advisor: 'bg-electric-500/20 text-electric-400 border-electric-500/30',
  officer: 'bg-electric-500/20 text-electric-400 border-electric-500/30',
  member:  'bg-gold-500/20 text-gold-400 border-gold-500/30',
  guest:   'bg-space-600/40 text-ink-muted border-space-500/30',
};
...
const MemberDirectory: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* Controls */}
      <div className="sticky top-20 z-20 bg-space-900 border-b border-space-500/30">
