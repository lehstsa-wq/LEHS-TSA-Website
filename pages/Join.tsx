...
import { ChevronDown, ChevronUp, ExternalLink, ArrowRight, FileCheck, CreditCard, MessageSquare, CheckCircle2 } from 'lucide-react';
    ...
    <div>
      ...
      <section className="py-8 px-4 text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="max-w-lg mx-auto">
          ...
          <p className="text-ink-dim mb-6">Join LEHS TSA today and start building the skills, network, and achievements that define a tech career.</p>
