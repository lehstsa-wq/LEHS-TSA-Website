  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-mesh': 'radial-gradient(ellipse 80% 60% at 50% -20%, rgba(59,130,246,0.25), transparent), radial-gradient(ellipse 60% 80% at 80% 50%, rgba(139,92,246,0.15), transparent), radial-gradient(ellipse 60% 50% at 20% 80%, rgba(224,92,92,0.12), transparent)',
